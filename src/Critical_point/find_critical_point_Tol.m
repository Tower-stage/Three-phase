...
% L8-Bo / Toluene 多项式系数 (g12)
p1 = 21.0142; p2 = -53.8880; p3 = 50.9171; p4 = -24.4012; p5 = -1.8878;
...
% Gibbs 自由能二阶导数矩阵元素（与 spinodal-gemini 严格一致）
...
fprintf('========================================\n');
fprintf('PM6-L8Bo-Toluene 体系临界点计算完成\n');
fprintf('========================================\n');
fprintf('  phi1 (L8-Bo)   = %.6f\n', x1_crit);
fprintf('  phi2 (Toluene) = %.6f\n', x2_crit);
fprintf('  phi3 (PM6)     = %.6f\n', x3_crit);
fprintf('========================================\n');

%% 6. 保存结果
crit_result = table(x1_crit, x2_crit, x3_crit, ...
    'VariableNames', {'phi1_L8Bo','phi2_Tol','phi3_PM6'});
writetable(crit_result, 'critical_point_Tol.csv');
fprintf('结果已保存至 critical_point_Tol.csv\n');
