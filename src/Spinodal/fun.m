...
% 这里应该有个类似于g12的数据，可惜消失了，应该对应后面的p1-p5
% 此处的三个常数对应一种计算g12的三元拟合模型
