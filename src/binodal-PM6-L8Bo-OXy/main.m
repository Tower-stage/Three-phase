...
xsol(isnan(xsol(:,1)), :) = [];
writetable(array2table(xsol, 'VariableNames', {'residual','phi1_L8Bo','phi3_PM6','phi2_oXy'}), 'binodal_PM6_L8Bo_OXy.csv');
disp('Binodal 解算完成，结果已保存至 binodal_PM6_L8Bo_OXy.csv');
