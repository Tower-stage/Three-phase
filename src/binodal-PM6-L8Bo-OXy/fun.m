...
% PM6 - L8-Bo - o-Xylene 三元体系 Binodal 计算函数
...
% ======== 物理参数区（PM6-L8Bo-oXy 体系）========
v1 = 1132.1;      % L8-Bo 摩尔体积 [cm^3/mol] (MW~1478, rho~1.3)
v2 = 120.6;       % o-Xylene 摩尔体积 (MW=106.17, rho=0.88)
...
% --- o-Xylene(2) - PM6(3) 相互作用参数 (g23) ---
kk = 0;
bb = 0.4120;      % PM6/o-Xylene, 源自 UNIFAC 估算
g23c = kk*x3c + bb;
g23d = kk*x3d + bb;
dg23c = kk;
dg23d = kk;

% --- L8-Bo(1) - o-Xylene(2) 相互作用参数 (g12, p1-p5 多项式) ---
% 基于 HSP 估算重新计算：chi ~ 0.60，考虑 L8-Bo 在 o-Xylene 中溶解度更差，上调至平均 0.65
% 假设 g12 随溶剂浓度增加线性降低（从 0.75 到 0.55）
p1 = 0;
p2 = 0;
p3 = 0;
p4 = -0.2000;
